...
export default function BillingSubscriptionsPage() {
  ...
  return (
    <div className="min-h-screen bg-[#07090E] text-slate-100 selection:bg-indigo-500/30 font-sans pb-24">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 space-y-10">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-white/[0.08] pb-6">
          ...
          <div className="flex items-center gap-3">
            <Button
              ...
              className="bg-slate-900/60 border-white/10 text-slate-300 hover:bg-slate-800 hover:text-white transition-all backdrop-blur-sm"
            >
            ...
            <Button
              ...
              className="bg-gradient-to-r from-indigo-600 via-indigo-500 to-purple-600 hover:from-indigo-500 hover:to-purple-500 text-white shadow-lg shadow-indigo-600/25 border-0 font-medium transition-all"
            >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          ...
          <Card className="lg:col-span-5 bg-gradient-to-b from-slate-900/90 via-slate-900/60 to-slate-950/80 border-white/10 backdrop-blur-xl shadow-2xl relative overflow-hidden flex flex-col justify-between">
              ...
              <div className="mt-4 flex items-baseline justify-between">
                <div>
                  <CardTitle className="text-2xl font-bold text-white flex items-center gap-2">
                    ...
                    <Badge className="bg-indigo-600/80 text-white hover:bg-indigo-600 text-[10px] uppercase font-bold tracking-wider">
                      Active
                    </Badge>
                  </CardTitle>
            ...
            <CardContent className="space-y-4 pt-0">
              ...
              <div className="space-y-2 pt-1 text-xs text-slate-300">
                <div className="flex items-center justify-between py-1 border-b border-white/[0.04]">
                  ...
                  <span className="font-semibold text-white">8 / 10 Active Seats</span>
                </div>
                <div className="flex items-center justify-between py-1 border-b border-white/[0.04]">
                  <span className="text-slate-400 flex items-center gap-2">
                ...
                <div className="flex items-center justify-between py-1 border-b border-white/[0.04]">
                  ...
                  <span className="font-semibold text-white">SOC-2 Type II Certified</span>
                </div>
              </div>
            </CardContent>
            ...
            <CardFooter className="pt-2 border-t border-white/[0.06] flex items-center justify-between gap-3">
              ...
              <div className="flex items-center gap-2">
                ...
                <Button
                  ...
                  className="text-xs bg-indigo-600 hover:bg-indigo-500 text-white font-medium shadow-md shadow-indigo-600/30"
                >
                  Change Plan
                </Button>
              </div>
          ...
          <Card className="lg:col-span-7 bg-slate-900/70 border-white/10 backdrop-blur-xl shadow-xl flex flex-col justify-between">
            ...
            <CardContent className="space-y-5">
              ...
              <div className="space-y-1.5">
                <div className="flex justify-between text-xs">
                  ...
                  <span className="font-mono text-slate-300">
                    <strong className="text-white">84,250</strong> / 100,000 queries{" "}
              ...
              <div className="space-y-1.5">
                <div className="flex justify-between text-xs">
                  ...
                  <span className="font-mono text-slate-300">
                    <strong className="text-white">38.4 GB</strong> / 50 GB{" "}
              ...
              <div className="space-y-1.5">
                <div className="flex justify-between text-xs">
                  ...
                  <span className="font-mono text-slate-300">
                    <strong className="text-white">8</strong> / 10 seats{" "}
              ...
              return (
                <div
                  ...
                  className={`relative rounded-2xl transition-all duration-300 flex flex-col ${
                    plan.isPopular
                      ? "bg-gradient-to-b from-indigo-950/60 via-slate-900/90 to-slate-950 border-2 border-indigo-500/60 shadow-2xl shadow-indigo-950/50 scale-[1.02] z-10"
                      : "bg-slate-900/60 border border-white/10 hover:border-white/20 hover:bg-slate-900/80 shadow-lg"
                  ...
                  <div className="p-6 sm:p-7 flex-1 flex flex-col justify-between">
                    <div>
                      ...
                      <div className="flex items-center justify-between gap-2 mb-3">
                        ...
                        {plan.badge && (
                          <span className="px-2.5 py-0.5 text-[10px] font-extrabold tracking-wider uppercase rounded-full bg-indigo-500 text-white shadow-sm shadow-indigo-500/40">
                            {plan.badge}
                          </span>
                        )}
                      </div>
                      ...
                      <div className="grid grid-cols-2 gap-2 mb-6 text-[11px] font-mono text-slate-300">
                        <div className="p-2 rounded-lg bg-black/40 border border-white/[0.04]">
                          ...
                          <span className="font-semibold text-white">{plan.quota.tokens}</span>
                        </div>
                        <div className="p-2 rounded-lg bg-black/40 border border-white/[0.04]">
                          <span className="text-slate-400 block text-[10px]">STORAGE</span>
                          <span className="font-semibold text-white">{plan.quota.storage}</span>
                        </div>
                        <div className="p-2 rounded-lg bg-black/40 border border-white/[0.04]">
                          <span className="text-slate-400 block text-[10px]">TEAM SEATS</span>
                          <span className="font-semibold text-white">{plan.quota.seats}</span>
                        </div>
                        <div className="p-2 rounded-lg bg-black/40 border border-white/[0.04]">
                          ...
                          {plan.features.map((feature, i) => (
                            <li key={i} className="flex items-start gap-2.5">
                              {feature.included ? (
                                ...
                                <div className="mt-0.5 rounded-full p-0.5 bg-slate-800 text-slate-600 flex-shrink-0">
                    ...
                    <div className="pt-8">
                      <Button
                        ...
                        className={`w-full py-5 text-xs font-semibold rounded-xl transition-all duration-200 ${
                          isCurrent
                            ? "bg-slate-800/80 text-slate-400 border border-white/10 cursor-default"
                            : plan.isPopular
                            ? "bg-gradient-to-r from-indigo-600 via-indigo-500 to-purple-600 hover:from-indigo-500 hover:to-purple-500 text-white shadow-xl shadow-indigo-600/30 border-0"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 pt-4">
            ...
            <div className="flex items-center justify-between">
              ...
              <Dialog open={isAddCardOpen} onOpenChange={setIsAddCardOpen}>
                <DialogTrigger asChild>
                  <Button
                    size="sm"
                    className="bg-indigo-600/90 hover:bg-indigo-500 text-white text-xs font-medium shadow-md shadow-indigo-600/20"
                  >
                    <Plus className="w-3.5 h-3.5 mr-1.5" />
                    Add Payment Method
                  </Button>
                </DialogTrigger>
                <DialogContent className="bg-slate-900 border-white/10 text-slate-100 max-w-md backdrop-blur-2xl">
                  <DialogHeader>
                  ...
                  <form onSubmit={handleAddCard} className="space-y-4 pt-2">
                    {/* Live Preview Card */}
                    <div className="p-4 rounded-xl bg-gradient-to-tr from-slate-950 via-indigo-950 to-blue-900 border border-white/20 text-white shadow-xl relative overflow-hidden">
                      ...
                      <div className="font-mono text-base tracking-widest text-slate-100 mb-4">
                        {newCardNumber || "•••• •••• •••• ••••"}
                      </div>
                    ...
                    <div className="space-y-3 text-xs">
                      ...
                      <div>
                        ...
                        <Input
                          ...
                          className="bg-black/40 border-white/10 text-white font-mono mt-1 text-xs"
                          maxLength={19}
                          required
                        />
                      </div>
                      ...
                      <div>
                        ...
                        <Input
                          ...
                          className="bg-black/40 border-white/10 text-white mt-1 text-xs uppercase"
                          required
                        />
                      </div>
              ...
              {paymentMethods.map((method) => (
                ...
                >
                      ...
                      <DropdownMenu>
                        <DropdownMenuTrigger asChild>
                          <Button
                            variant="ghost"
                            size="sm"
                            className="h-7 w-7 p-0 rounded-full text-slate-400 hover:text-white hover:bg-white/10"
                          >
                        ...
                        <DropdownMenuContent
                          align="end"
                          className="bg-slate-900 border-white/10 text-slate-200 text-xs"
                        >
                  ...
                  <div className="z-10 my-2">
                    ...
                    <div className="font-mono text-base tracking-widest text-white font-semibold flex items-center gap-2 mt-0.5">
                      <span>••••</span>
                      <span>••••</span>
                      <span>••••</span>
          ...
          <div className="lg:col-span-5">
            <Card className="bg-slate-900/70 border-white/10 backdrop-blur-xl shadow-xl h-full flex flex-col justify-between">
              <CardHeader className="pb-3">
                <div className="flex items-center justify-between">
              ...
              <CardContent className="space-y-3.5 text-xs text-slate-300">
                <div className="p-3 rounded-xl bg-black/30 border border-white/[0.06] space-y-2">
                  <div className="flex justify-between">
                    ...
                    <span className="font-semibold text-white">{billingInfo.companyName}</span>
                  </div>
                  <div className="flex justify-between">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="text-slate-200">{billingInfo.billingEmail}</span>
                  </div>
                  <div className="flex justify-between">
        ...
        <div className="space-y-4 pt-4">
            ...
            <div className="flex flex-wrap items-center gap-2">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  className="h-8 pl-8 text-xs bg-slate-900/80 border-white/10 text-white w-48 sm:w-56"
                />
              </div>

              {/* Status Filter Tabs */}
              <div className="flex items-center bg-slate-900/80 border border-white/10 p-0.5 rounded-lg text-xs">
              ...
              <Button
                ...
                className="h-8 text-xs bg-slate-900 border-white/10 text-slate-300 hover:bg-slate-800"
              >
          ...
          {/* Invoices Table Card */}
          <Card className="bg-slate-900/70 border-white/10 backdrop-blur-xl shadow-xl overflow-hidden">
                  ...
                  {filteredInvoices.length === 0 ? (
                    ...
                    filteredInvoices.map((invoice) => (
                      ...
                      >
                        ...
                        {/* Amount */}
                        <TableCell className="text-xs font-bold font-mono text-white">
                              ...
                              <Tooltip>
                                <TooltipTrigger asChild>
                                  <Button
                                    ...
                                    className="h-7 w-7 p-0 rounded-md text-slate-300 hover:text-white hover:bg-white/10"
                                  >
            ...
            <div className="p-4 bg-black/40 border-t border-white/[0.08] flex flex-wrap items-center justify-between text-xs text-slate-400 gap-3">
              <div>
                Showing <strong className="text-white">{filteredInvoices.length}</strong> invoices for calendar year 2026.
              </div>
        ...
        <div className="p-6 rounded-2xl bg-gradient-to-r from-slate-900 via-indigo-950/40 to-slate-900 border border-white/10 backdrop-blur-xl flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="space-y-1">
      ...
      <Dialog open={isReceiptOpen} onOpenChange={setIsReceiptOpen}>
        <DialogContent className="bg-slate-900 border-white/10 text-slate-100 max-w-xl backdrop-blur-2xl">
          {selectedInvoice && (
            <div className="space-y-5">
              ...
              <div className="grid grid-cols-2 gap-4 text-xs">
                <div className="space-y-1 p-3 rounded-lg bg-black/30 border border-white/[0.04]">
                  ...
                  <div className="font-bold text-white">Neurometric Insights Inc.</div>
                ...
                <div className="space-y-1 p-3 rounded-lg bg-black/30 border border-white/[0.04]">
                  ...
                  <div className="font-bold text-white">{billingInfo.companyName}</div>
                  ...
                  <TableBody>
                    {selectedInvoice.items.map((item, index) => (
                      <TableRow key={index} className="border-b border-white/[0.04]">
                        ...
                        <TableCell className="text-right text-xs font-mono font-semibold text-white">
      ...
      <Dialog open={isEditBillingOpen} onOpenChange={setIsEditBillingOpen}>
        <DialogContent className="bg-slate-900 border-white/10 text-slate-100 max-w-lg backdrop-blur-2xl">
          <DialogHeader>
            <DialogTitle className="text-lg font-bold text-white flex items-center gap-2">
          ...
          <form onSubmit={handleSaveBillingInfo} className="space-y-3.5 pt-2 text-xs">
            <div>
              ...
              <Input
                ...
                className="bg-black/40 border-white/10 text-white mt-1 text-xs"
                required
              />
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="p-4 rounded-xl bg-black/40 border border-white/[0.08] space-y-3 text-xs">
                <div className="flex justify-between items-center pb-2 border-b border-white/[0.06]">
                  ...
                  <span className="font-bold text-white text-sm">{targetPlan.name} Plan</span>
                </div>
                <div className="flex justify-between items-center pb-2 border-b border-white/[0.06]">
                ...
                <div className="flex justify-between items-center pb-2 border-b border-white/[0.06]">
                  ...
                  <span className="font-mono text-white">{targetPlan.quota.tokens}</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-slate-400">Prorated Adjustment Today:</span>
                  <span className="font-mono text-slate-200">$0.00 (Applies next cycle)</span>
                </div>
              </div>
