...
export default function UsagePage() {
  ...
  return (
    <div className="relative min-h-screen bg-[#07090e] text-slate-100 antialiased selection:bg-indigo-500/30 selection:text-indigo-200">
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        {/* ========================================================================= */}
        <div className="flex flex-col gap-6 border-b border-zinc-800/80 pb-6 md:flex-row md:items-center md:justify-between">
          <div className="space-y-1.5">
            <div className="flex items-center gap-2 text-xs font-medium tracking-wide text-zinc-400 uppercase">
              ...
              <span>/</span>
              <span className="text-slate-200">GPT-4o Engine</span>
            </div>
            ...
            <p className="text-sm text-zinc-400 max-w-2xl">
              Track real-time token volume for <span className="text-zinc-200 font-medium">GPT-4o</span>, monitor Prompt Caching efficiency, inspect request velocity, and manage organization spend limits.
            </p>
          </div>
          ...
          <div className="flex flex-wrap items-center gap-3">
            <Select value={selectedKey} onValueChange={setSelectedKey}>
              <SelectTrigger className="w-[190px] bg-zinc-900/80 border-zinc-800 text-xs text-zinc-200 hover:bg-zinc-800/60 focus:ring-indigo-500">
            ...
            <Select value={selectedPeriod} onValueChange={setSelectedPeriod}>
              <SelectTrigger className="w-[180px] bg-zinc-900/80 border-zinc-800 text-xs text-zinc-200 hover:bg-zinc-800/60 focus:ring-indigo-500">
            ...
            <Button
              ...
              className="bg-zinc-900/80 border-zinc-800 text-zinc-200 hover:bg-zinc-800 hover:text-white"
            >
            ...
            <Button
              ...
              className="bg-gradient-to-r from-indigo-600 to-indigo-700 hover:from-indigo-500 hover:to-indigo-600 text-white shadow-lg shadow-indigo-600/20 border-0 flex items-center gap-1.5"
            >
        ...
        <div className="mt-8 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <Card className="relative overflow-hidden border-zinc-800/80 bg-zinc-900/50 backdrop-blur-xl shadow-xl hover:border-zinc-700/80 transition-all duration-200 group">
            ...
            <CardContent className="space-y-3">
              ...
              <div className="space-y-1.5 pt-1">
                <div className="flex justify-between text-xs text-zinc-400">
                  ...
                  <span className="font-mono font-semibold text-zinc-200">{spendPercentage}%</span>
                </div>
              ...
              <div className="flex items-center justify-between border-t border-zinc-800/60 pt-2.5 text-xs text-zinc-400">
                <span>Run-rate: <strong className="text-zinc-300 font-mono">$46.08/day</strong></span>
          ...
          <Card className="relative overflow-hidden border-zinc-800/80 bg-zinc-900/50 backdrop-blur-xl shadow-xl hover:border-zinc-700/80 transition-all duration-200 group">
            ...
            <CardContent className="space-y-3">
              ...
              <div className="flex items-center justify-between border-t border-zinc-800/60 pt-2.5 text-xs text-zinc-400">
                <span>Input: <strong className="text-zinc-300 font-mono">98.4M</strong></span>
                <span>Output: <strong className="text-zinc-300 font-mono">44.4M</strong></span>
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent className="space-y-3">
              <div className="flex items-baseline justify-between">
                <div>
                  ...
                  <span className="text-xs text-zinc-400 ml-1">TPM</span>
                </div>
              ...
              <div className="flex items-center justify-between border-t border-zinc-800/60 pt-2.5 text-xs text-zinc-400">
                <span>RPM: <strong className="text-zinc-300 font-mono">{currentRPM} / {rpmLimit} ({rpmPercentage}%)</strong></span>
        ...
        {/* ========================================================================= */}
        <div className="mt-8 rounded-2xl border border-zinc-800/80 bg-zinc-900/40 p-6 backdrop-blur-xl shadow-2xl">
          <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between border-b border-zinc-800/60 pb-5">
            <div>
            ...
            <div className="flex items-center gap-4">
              <div className="flex items-center space-x-2 rounded-lg bg-zinc-800/60 px-3 py-1.5 border border-zinc-700/50">
                <Switch
                  id="hard-cap"
                ...
                <label
                  htmlFor="hard-cap"
                  className="text-xs font-medium leading-none text-zinc-200 cursor-pointer"
                >
              ...
              <Button
                variant="outline"
                size="sm"
                className="bg-zinc-800/80 border-zinc-700 text-xs text-zinc-200 hover:bg-zinc-700"
                onClick={() => {
            ...
            <div className="rounded-xl border border-zinc-800/80 bg-zinc-950/50 p-4 space-y-3">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-xs font-bold uppercase text-zinc-300">Monthly Budget Cap</span>
                </div>
            ...
            <div className="rounded-xl border border-zinc-800/80 bg-zinc-950/50 p-4 space-y-3">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-xs font-bold uppercase text-zinc-300">GPT-4o TPM Ceiling</span>
                </div>
            ...
            <div className="rounded-xl border border-zinc-800/80 bg-zinc-950/50 p-4 space-y-3">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-xs font-bold uppercase text-zinc-300">Daily Soft Target</span>
                </div>
          ...
          <Tabs defaultValue="overview" className="w-full space-y-6">
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 border-b border-zinc-800/80 pb-3">
              <TabsList className="bg-zinc-900/90 border border-zinc-800 p-1 rounded-xl">
                <TabsTrigger
                  value="overview"
                  className="data-[state=active]:bg-indigo-600 data-[state=active]:text-white text-xs font-medium px-4 py-2 rounded-lg transition-all"
                >
            ...
            <TabsContent value="overview" className="space-y-6">
              <div className="grid grid-cols-1 gap-6 lg:grid-cols-12">
                ...
                <Card className="lg:col-span-8 border-zinc-800/80 bg-zinc-900/50 backdrop-blur-xl shadow-xl">
                ...
                <Card className="lg:col-span-4 border-zinc-800/80 bg-zinc-900/50 backdrop-blur-xl shadow-xl">
              ...
              <Card className="border-zinc-800/80 bg-zinc-900/50 backdrop-blur-xl shadow-xl">
                <CardHeader className="flex flex-row items-center justify-between pb-2">
                  <div>
            ...
            <TabsContent value="models" className="space-y-6">
              <div className="grid grid-cols-1 gap-6 lg:grid-cols-12">
                {/* Donut Chart */}
                <Card className="lg:col-span-5 border-zinc-800/80 bg-zinc-900/50 backdrop-blur-xl shadow-xl">
                  <CardHeader>
                  ...
                  <CardContent className="flex flex-col items-center justify-center">
                    ...
                    <div className="w-full space-y-2 pt-2">
                      {MODEL_SHARE_DATA.map((item, idx) => (
                        <div key={idx} className="flex items-center justify-between text-xs border-b border-zinc-800/50 pb-1.5 last:border-0">
                          <div className="flex items-center gap-2">
                ...
                <div className="lg:col-span-7 space-y-4">
                  {Object.entries(PRICING_RATES).map(([modelKey, rate]) => (
                    <div
                      key={modelKey}
                      className="rounded-xl border border-zinc-800/80 bg-zinc-900/60 p-4 backdrop-blur-md hover:border-zinc-700 transition-all space-y-3"
                    >
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-2.5">
                          ...
                          {modelKey === "gpt-4o" && (
                            <Badge className="bg-indigo-600 text-white text-[10px]">Primary Production Engine</Badge>
                          )}
                        </div>
                        <span className="text-xs text-zinc-400 font-mono">Context: 128k Tokens</span>
                      </div>

                      <div className="grid grid-cols-3 gap-3 rounded-lg bg-zinc-950/60 p-3 text-xs">
                        <div>
                          <span className="text-zinc-500 block">Prompt Input</span>
                        ...
                        <div>
                          <span className="text-zinc-500 block">Output / Completion</span>
                          <span className="text-zinc-200 font-mono font-bold text-sm">
              ...
              <div className="rounded-xl border border-indigo-500/30 bg-gradient-to-r from-indigo-950/40 via-purple-950/20 to-zinc-900/60 p-5 backdrop-blur-xl">
                <div className="flex items-start gap-3.5">
                  ...
                  <div className="space-y-1.5 flex-1">
                    ...
                    <p className="text-xs text-zinc-300 leading-relaxed">
                      1. <strong className="text-indigo-300">Prompt Prefix Static Alignment:</strong> Group system prompts in the <code className="text-zinc-200 bg-zinc-800/80 px-1 py-0.5 rounded">doc-rag-pipeline</code> to trigger OpenAI automatic 50% cached discounts for identical blocks {'>'} 1024 tokens.
                    </p>
                    <p className="text-xs text-zinc-300 leading-relaxed">
                      2. <strong className="text-indigo-300">Model Cascading:</strong> Routing lightweight sentiment & JSON tagging tasks from <code className="text-zinc-200 bg-zinc-800/80 px-1 py-0.5 rounded">gpt-4o</code> to <code className="text-cyan-300 bg-zinc-800/80 px-1 py-0.5 rounded">gpt-4o-mini</code> reduces token expenditure by ~97% with negligible quality loss.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <TabsContent value="simulator" className="space-y-6">
              <div className="grid grid-cols-1 gap-6 lg:grid-cols-12">
                {/* Sliders Form Card */}
                <Card className="lg:col-span-6 border-zinc-800/80 bg-zinc-900/50 backdrop-blur-xl shadow-xl">
                  <CardHeader>
                    <CardTitle className="text-base font-bold text-white flex items-center gap-2">
                  ...
                  <CardContent className="space-y-6">
                    ...
                    <div className="space-y-2">
                      <div className="flex justify-between text-xs">
                        <label className="font-semibold text-zinc-300">Input / Prompt Volume</label>
                      ...
                      <input
                        ...
                        className="w-full accent-indigo-500 cursor-pointer bg-zinc-800 h-2 rounded-lg"
                      />
                    ...
                    <div className="space-y-2">
                      <div className="flex justify-between text-xs">
                        <label className="font-semibold text-zinc-300">Output / Completion Volume</label>
                      ...
                      <input
                        ...
                        className="w-full accent-pink-500 cursor-pointer bg-zinc-800 h-2 rounded-lg"
                      />
                      <div className="flex justify-between text-[10px] text-zinc-500 font-mono">
                        <span>0.5M</span>
                        <span>15M</span>
                ...
                <Card className="lg:col-span-6 border-zinc-800/80 bg-zinc-900/50 backdrop-blur-xl shadow-xl flex flex-col justify-between">
                  <CardHeader>
                    <CardTitle className="text-base font-bold text-white flex items-center justify-between">
                    ...
                    <div className="rounded-xl border border-indigo-500/30 bg-indigo-950/20 p-4 space-y-2">
                      <div className="flex items-center justify-between">
                        ...
                        <span className="text-2xl font-black text-white font-mono">
                          ${simCalculations.gpt4oTotal} <span className="text-xs font-normal text-zinc-400">USD</span>
                        </span>
                      </div>
                      <div className="grid grid-cols-3 gap-2 text-[11px] font-mono text-zinc-400 pt-1 border-t border-indigo-900/40">
                        <div>Uncached In: <strong className="text-zinc-200">${simCalculations.gpt4oUncachedInputCost}</strong></div>
                    ...
                    <div className="rounded-xl border border-cyan-500/30 bg-cyan-950/20 p-4 space-y-2">
                      <div className="flex items-center justify-between">
                        ...
                        <span className="text-2xl font-black text-cyan-300 font-mono">
                          ${simCalculations.miniTotal} <span className="text-xs font-normal text-zinc-400">USD</span>
                        </span>
                      </div>
                  ...
                  <CardFooter className="border-t border-zinc-800/80 pt-4">
                    <Button
                      ...
                      className="w-full bg-zinc-800 hover:bg-zinc-700 text-zinc-200 text-xs flex items-center justify-center gap-1.5"
                    >
              ...
              <Card className="border-zinc-800/80 bg-zinc-900/50 backdrop-blur-xl shadow-xl">
                  ...
                  <div className="flex items-center gap-3">
                    <div className="relative w-48 sm:w-64">
                      ...
                      <Input
                        ...
                        className="pl-8 bg-zinc-950/80 border-zinc-800 text-xs text-zinc-200 h-9"
                      />
                    </div>

                    <Select value={modelFilter} onValueChange={setModelFilter}>
                      <SelectTrigger className="w-[140px] bg-zinc-950/80 border-zinc-800 text-xs text-zinc-200 h-9">
                ...
                <CardContent className="p-0">
                  <div className="overflow-x-auto">
                    <Table>
                      <TableHeader className="bg-zinc-950/60 border-zinc-800">
                        <TableRow className="border-zinc-800 hover:bg-transparent text-zinc-400 text-xs">
                          <TableHead className="font-semibold text-zinc-300">Request ID & Time</TableHead>
                          <TableHead className="font-semibold text-zinc-300">Model</TableHead>
                          <TableHead className="font-semibold text-zinc-300">Service / Agent</TableHead>
                          <TableHead className="font-semibold text-zinc-300 text-right">Prompt Tokens</TableHead>
                          <TableHead className="font-semibold text-zinc-300 text-right">Cached Input</TableHead>
                          <TableHead className="font-semibold text-zinc-300 text-right">Completion</TableHead>
                          <TableHead className="font-semibold text-zinc-300 text-right">Latency</TableHead>
                          <TableHead className="font-semibold text-zinc-300 text-right">Est. Cost</TableHead>
                        </TableRow>
                      </TableHeader>
                      <TableBody>
                        {filteredLogs.map((log) => (
                          <TableRow
                            key={log.id}
                            className="border-zinc-800/60 text-xs hover:bg-zinc-800/40 transition-colors"
                          >
                ...
                <CardFooter className="flex items-center justify-between border-t border-zinc-800/80 p-4 text-xs text-zinc-400">
                  <span>Showing {filteredLogs.length} live requests</span>
                  <div className="flex items-center gap-2">
                    <Button variant="outline" size="sm" disabled className="bg-zinc-950 border-zinc-800 text-zinc-600 text-xs h-7">
                      Previous
                    </Button>
                    <Button variant="outline" size="sm" className="bg-zinc-950 border-zinc-800 text-zinc-300 hover:bg-zinc-800 text-xs h-7">
                      Next
                    </Button>
                  </div>
                </CardFooter>
