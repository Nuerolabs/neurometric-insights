  ...
  return (
    <div className="flex flex-row gap-3">
      <a
        ...
        className="flex h-9 items-center gap-1.5 rounded-full bg-[#25D366] px-4 text-xs text-white font-medium hover:opacity-90 transition-opacity"
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="flex h-9 items-center gap-1.5 rounded-full bg-foreground px-4 text-xs text-background font-medium hover:opacity-90 transition-opacity"
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="flex h-9 items-center gap-1.5 rounded-full bg-[#0A66C2] px-4 text-xs text-white font-medium hover:opacity-90 transition-opacity"
