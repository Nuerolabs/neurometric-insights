...
export default function DashboardVentas() {
  const { ventas, totalHoy, totalSemana, totalMes, totalPendiente, ventasHoy, ventasPorTipo, ventasPendientes } = useVentas();
    ...
    <VentasLayout>
      <div className="pt-page">
        ...
        <div className="pt-stats-grid">
          ...
          <StatCard icon={Calendar} label="Este Mes" value={formatCOP(totalMes)} color="#7c3aed" />
